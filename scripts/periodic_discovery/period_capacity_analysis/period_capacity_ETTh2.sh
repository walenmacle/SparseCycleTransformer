...
# Period Capacity Analysis on ETTh2

# Hypothesis: '32' is optimal for ETTh2 (Daily, Weekly, etc.), going too low (2) misses periods, too high (16) adds noise.

echo "=== Period Capacity Analysis: ETTh2 ==="
...
do
  ...
  python -u run.py \
    ...
    --data_path ETTh2.csv \
    --model_id ETTh2_96_96_Period_${n_tokens} \
